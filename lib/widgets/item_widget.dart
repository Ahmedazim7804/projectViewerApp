      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            ListTile(leading: const Icon(Icons.web_rounded),title: Text("Github Links", style: Theme.of(context).textTheme.titleMedium),subtitle: ListView.builder(shrinkWrap: true,itemBuilder: (ctx, index) => InkWell(onTap: (){openLink(gitRepoUrls![index]);},child: Text('${index+1}. ${gitRepoUrls![index]}', style: Theme.of(context).textTheme.titleSmall!.copyWith(color: Colors.blueGrey, decoration: TextDecoration.underline),)),itemCount: gitRepoUrls!.length,))
            ],
          ),
        ),
      );
